 ...
 * Original file: /Users/alexandre/EclipseProjects/MediaSenseCall/src/com/android/internal/telephony/ITelephony.aidl
 */
...
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.silenceRinger();
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
/**
     * Silence ringer on call
     *
     * @return whether it is silence or not
     */
public boolean silenceRinger() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
